...
final class Version20231020110641 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // Create default user
        $this->addSql("INSERT INTO user (email, roles, password, name_identifier, firstname_identifier, pseudo, activated, picture_identifier) VALUES ('k.filatre@snowtricks.fr', '".json_encode(['ROLES_ADMIN'])."', '$2y$10$1nCqWUzBZcLRT.gKcTvpSuzlkChgMcW6Jg7rE6LtpYcKDkSUbZ//O', 'Filatre', 'Killian', 'killiadmin', 1, 'default_avatar.webp')");
    }
